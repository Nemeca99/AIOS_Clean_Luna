#!/usr/bin/env python3
"""
CARMA Core Model Configuration
Self-contained model configuration for CARMA core
"""
...
# Re-export for easy access within CARMA core
__all__ = ['get_main_model', 'get_embedder_model', 'get_draft_model']

# Convenience functions for CARMA-specific model access
def get_carma_embedder_model():
    """Get the embedder model for CARMA operations"""
    return get_embedder_model()

def get_carma_main_model():
    """Get the main model for CARMA operations"""
