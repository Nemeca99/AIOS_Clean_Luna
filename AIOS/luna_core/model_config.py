#!/usr/bin/env python3
"""
Luna Core Model Configuration
Self-contained model configuration for Luna core
"""
...
# Re-export for easy access within Luna core
__all__ = ['get_main_model', 'get_embedder_model', 'get_draft_model']

# Convenience functions for Luna-specific model access
def get_luna_main_model():
    """Get the main model for Luna responses"""
    return get_main_model()

def get_luna_embedder_model():
    """Get the embedder model for Luna"""
    return get_embedder_model()

def get_luna_draft_model():
    """Get the draft model for Luna (if enabled)"""
