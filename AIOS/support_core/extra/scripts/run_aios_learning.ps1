# AIOS Learning System V2 - PowerShell Launcher
...
Write-Host "PowerShell Environment Detected" -ForegroundColor Yellow
Write-Host "This system offers two powerful learning modes:" -ForegroundColor White
Write-Host ""
...
# Run the PowerShell-friendly version
python aios_learning_powershell_friendly.py
