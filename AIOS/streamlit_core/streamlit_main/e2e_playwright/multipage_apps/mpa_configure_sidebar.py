...
small_logo = Image.open(str(pathlib.Path(__file__).parent / "small-streamlit.png"))  # TODO: Convert to context manager

logo = Image.open(str(pathlib.Path(__file__).parent / "full-streamlit.png"))  # TODO: Convert to context manager
