...
SMALL_LOGO = Image.open(str(PARENT_DIR / "small-streamlit.png"))  # TODO: Convert to context manager

LOGO = Image.open(str(PARENT_DIR / "full-streamlit.png"))  # TODO: Convert to context manager
