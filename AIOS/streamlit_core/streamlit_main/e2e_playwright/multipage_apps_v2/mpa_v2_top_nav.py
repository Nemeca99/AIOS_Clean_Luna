...
LOGO_FULL = Image.open(str(PARENT_DIR / "full-streamlit.png"))  # TODO: Convert to context manager
LOGO_SMALL = Image.open(str(PARENT_DIR / "small-streamlit.png"))  # TODO: Convert to context manager
